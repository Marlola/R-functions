lucR - allocation of land use change 
---

The "simple land use model" is adapted alucR version for a one class land use sceanrio. Land use change is modelled based on the suitability surface of the modelled land use class (derived for example via logistic regression) and allocated/expanded over a detailed land use map at initialisation time (lu). 
 ...
 ***To Use the Function*** run the code  simple_lu_model.R in your R-console. 
