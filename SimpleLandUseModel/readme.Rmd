...
The "simple land use model" is adapted alucR (https://github.com/fg-code/alucR) version for a one class land use sceanrio. Land use change is modelled based on a suitability surface of the modelled land use class (derived for example via logistic regression) and allocated/expanded over a detailed land use map at initialisation time (lu). 
